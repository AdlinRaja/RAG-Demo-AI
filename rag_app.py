        ...
        if query:
            with st.chat_message('human'):
                ...
                with st.spinner('Analysing the document...'):
                    ...
                    prompt=f''' you are an AI expert. Use the generated content {content} to answer the query {query},
                    If you are not sure with the answer say "I have no content related to this question,
                    Please ask relevant question to answer
